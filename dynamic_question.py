...
def generate_content(query, position, context, is_question=False):
    ...
    if is_question:
        ...
        system_content = (
            ...
            "Provide specific, actionable feedback in a supportive tone. If the response was incorrect, provide the correct answer. "
            "If it was correct, suggest ways to improve the response by elaborating on the answer, providing examples, or offering alternative approaches to present the answer more effectively."
        )
