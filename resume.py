...
def generate_content(query, position, context, is_question=False):
    ...
    if is_question:
        ...
        "Provide tips or ideas on how to answer the question effectively, such as asking for specific examples or encouraging the use of a structured response. "
...
def main():
    ...
    if resume_text and st.session_state.selected_position:
        ...
        resume_feedback = analyze_resume(resume_text, st.session_state.selected_position)
